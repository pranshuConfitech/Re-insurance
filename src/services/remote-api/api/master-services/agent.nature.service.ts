...
export class AgentNatureService {
  readonly COMMAND_CONTEXT = `/master-data-service/v1/natureofagent`;
  readonly QUERY_CONTEXT = `/master-data-service/v1/natureofagent`;
