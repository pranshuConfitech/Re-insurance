...
export default function CanellationModal(props:any) {
  const classes = useStyles();

  const formik = useFormik({
    initialValues: {
      action: 'ADMISSION_CANCELATION',
      reasonForAdmissionCancelation: 'MEMBER HAS NOT TAKEN ADMISSION AS CONFIRMED BY THE HOSPITAL',
      doa: '',
      remarks: '',
    },
  ...
  return (
    <Dialog
      ...
      disableEnforceFocus>
      <DialogTitle id="form-dialog-title">Admission Cancellation</DialogTitle>
      <DialogContent>
        <Grid container spacing={3} style={{ marginBottom: '20px' }}>
          ...
          <FormControl fullWidth>
            ...
            <Select
              ...
              id="reasonForAdmissionCancelation"
              name="reasonForAdmissionCancelation"
              value={formik.values.reasonForAdmissionCancelation}
