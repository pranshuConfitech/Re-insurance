...
import QuotationTabComponent from './quotation.tab.component';
...
const ModernButtonGroup = ({ value, onChange, classes }: any) => {
    return (
        <div className={classes.buttonGroup}>
            ...
            <Button
                className={`${classes.modernButton} ${value === 2 ? classes.buttonActive : classes.buttonInactive}`}
        ...
        <div className={classes.root}>
            ...
            <Paper className={classes.paperContainer} elevation={0}>
                ...
                <TabPanel value={tabValue} index={1}>
                    <QuotationTabComponent tabType="new" />
                </TabPanel>

                <TabPanel value={tabValue} index={2}>
                    <QuotationTabComponent tabType="renewal" />
                </TabPanel>
            </Paper>
        </div>
    );
...
export default QuotationDashboardMain;
