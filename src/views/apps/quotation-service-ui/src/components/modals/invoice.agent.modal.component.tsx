...
import { ProspectService } from '@/services/remote-api/fettle-remote-api'
...
export default function InvoiceAgentModal(props: any) {
  ...
  const dataSource$ = (fields: any, pageRequest = { page: 0, size: 10 }) => {
    return prospectService.getProspectDetails(props.prospectId).pipe(
      switchMap((result: any) => {
        const type = result.clientType;
