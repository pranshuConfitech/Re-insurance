...
export default function FundReceiptListComponent(props: any) {
  ...
  const handleOpen = () => {
    router.push('/receipts?mode=create&type=fund')
  }

  const openEditSection = (receipt: any) => {
    router.push(`/receipts/${receipt.id}?mode=view&type=fund`)
  }
