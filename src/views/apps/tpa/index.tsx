...
import TpaDetails from './tpa.details.component'
...
export default function Policy() {
  ...
  React.useEffect(() => {
    if (!query.get('mode')) {
      router.replace('/tpa?mode=viewList')
    }
  }, [query, router])
    ...
    <div>
      ...
      {(() => {
        switch (query.get('mode')) {
          case 'viewList':
            return <TpaListComponent rows={rows} columns={columns} />
          case 'create':
            return <TpaDetails />
          default:
            return null
